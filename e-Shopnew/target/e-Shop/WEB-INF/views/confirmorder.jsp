...
<td>${cartitems.productprice * cartitems.quantity }</td>
<td><img src="<c:url value='/images/${cartitems.productid}.jpg'/>" width="100" height="100">
</tr>
</c:forEach>
<tr>
...
<tr bgcolor="black">
<td colspan="2"><center><a href="receipt">payment<input type="submit" value="pay" /></a></center></td>
</table>
